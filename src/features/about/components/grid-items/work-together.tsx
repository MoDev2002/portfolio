...
const WorkTogether = () => {
    ...
    return (
        <BentoGridItem className='flex justify-center md:col-span-3 md:row-span-1 lg:col-span-2'>
            ...
            <BentoGridHeader className='max-w-60 justify-center text-center md:max-w-full'>
                <BentoGridTitle>
