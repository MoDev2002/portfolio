            ...
            >
                {navItems.map((navItem: any, idx: number) => (
                    <Link
                        ...
                        href={navItem.link}
                        className={cn(
                            'group relative flex items-center space-x-1 text-neutral-600 hover:text-neutral-500 dark:text-neutral-50 dark:hover:text-neutral-300'
                        )}
                    >
                        <div className='flex text-neutral-600 group-hover:text-neutral-500 dark:text-neutral-50 dark:group-hover:text-neutral-300'>
                            {navItem.icon}
                        </div>
